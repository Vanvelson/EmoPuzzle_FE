...
import "./fourth_all.css"; // Імпортуємо стилі для компонента
...
const Fourth_p_4 = () => {
  const Pages = [
    ...
    },
    {
      ...
      questions:
        "Питання: Що відчував Міло, коли Белла допомогла йому знайти шапочку?",
      answers: ["Радість", "Вдячність", "Здивування", "Полегшення"],
    },
    {
      ...
      questions: "Питання: Що відчувала Белла, коли дощ зіпсував пікнік?",
      answers: ["Смуток", "Злість", "Розчарування", "Зніяковіння"],
    },
    {
      ...
      answers: ["Радість", "Злість", "Розчарування", "Зніяковіння"],
    },
    {
      ...
      answers: ["Зніяковіння", "Подив", "Роздратування", "Вдячність"],
    },
  ];
  const translations = {
    ua: {
  ...
  const handleEmotionClick = (emotion) => {
    if (emotion === "Смуток") {
      ...
      navigate("/fourth_p_5"); // Navigate to the next page when "Смуток" is clicked
    } else {
  ...
  const handleNextClick = () => {
    navigate("/fourth_p_5"); // Navigate to the next page when "Далі" is clicked
  };
      ...
      <main className="container">
        ...
        <div className="first_story">
          <div className="text_block">
            <p>
              Рорі знову виклав своє коло, цього разу з особливою обережністю.
              Він навіть поставив охоронців-шишки на кути. Кожна деталь була на
              своєму місці, і він працював терпляче, навіть тихенько наспівуючи.
              Незабаром тварини почали збиратися на прогулянку. Вони зупинялися
              біля прикраси з широко розплющеними очима. — Це неймовірно! —
              сказала кролиця Белла, радісно обертаючись. Хвіст Рорі радісно
              ворухнувся. Він відійшов убік, дозволивши іншим насолодитися його
              роботою. — Дякую, — тихо посміхнувся він. Його злість зникла,
              поступившись теплій гордості.
            </p>
          </div>

          <div>
            <img
              src="./images/image_4_4.png"
              className="image_fox image_fox_4_4"
            />
          </div>
        </div>
        <h2>
          Питання: Що відчував Рорі, коли інші захоплювались його роботою?
        </h2>
