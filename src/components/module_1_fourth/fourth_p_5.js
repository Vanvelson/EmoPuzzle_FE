          ...
          ← 
                ...
                <div className="first_story">
                    <div className="text_block">
                        <p>Коли небо потемніло, а над стежкою замерехтіли світлячки, Рорі залишився біля своєї прикраси, спостерігаючи, як вона сяє під зорями. Бурундуки тихенько підійшли, опустивши вушка. Один тримав зім’ятий листочок.
                            — Вибач за раніше… — прошепотів він.
                            Рорі підняв брову, а потім усміхнувся.
                            — Нічого страшного. Просто наступного разу обережніше.
                            Вони всі разом засміялись і сіли поруч.
                            — Насправді вийшло дуже красиво, — сказав один.
                            Рорі кивнув.
                            — Дякую. Вийшло навіть краще, ніж я уявляв.
                        </p>
                    </div>

                    <div>
                        <img src="./images/image_4_5.png" className="image_fox image_fox_4_5" />
                    </div>
                </div>
                <h2>Питання: Що відчував Рорі, коли бурундуки вибачились?</h2>
