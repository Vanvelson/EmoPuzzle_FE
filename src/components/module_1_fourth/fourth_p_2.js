...
const Fourth_p_2 = () => {
  ...
  const handleEmotionClick = (emotion) => {
    if (emotion === "Смуток") {
      ...
      navigate("/fourth_p_3"); // Navigate to the next page when "Смуток" is clicked
    } else {
  ...
  const handleNextClick = () => {
    navigate("/fourth_p_3"); // Navigate to the next page when "Далі" is clicked
  };
      ...
      <main className="container">
        ...
        <div className="first_story">
          <div className="text_block">
            <p>
              Він зробив глибокий вдих і нахилився, щоб зібрати розкидані речі.
              Деякі листочки були порвані, а кілька камінців закотилися далеко.
              Поки Рорі їх збирав, він помітив щось дивне: частина його
              улюбленого синього каміння зникла. Він шукав під мохом, за
              корінням дерев, навіть перевірив свою сумку — але дарма. Його вуха
              сіпались, а мордочка хмурилась. — Куди ж вони поділись? —
              прошепотів він. Він присів і озирнувся довкола, не розуміючи, що
              відбувається. Чим більше думав, тим більше розгублювався.
            </p>
          </div>

          <div>
            <img
              src="./images/image_4_2.png"
              className="image_fox image_fox_4_2"
            />
          </div>
        </div>
        <h2>Питання: Що відчував Рорі, коли не міг знайти блискучі камінці?</h2>
