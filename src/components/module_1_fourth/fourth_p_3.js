...
const Fourth_p_3 = () => {
  ...
  const handleEmotionClick = (emotion) => {
    if (emotion === "Смуток") {
      ...
      navigate("/fourth_p_4"); // Navigate to the next page when "Смуток" is clicked
    } else {
  ...
  const handleNextClick = () => {
    navigate("/fourth_p_4"); // Navigate to the next page when "Далі" is clicked
  };
      ...
      <main className="container">
        ...
        <div className="first_story">
          <div className="text_block">
            <p>
              У цей момент повільно підійшла їжачка Тома в фартушку з плямами
              фарби. — Ти це шукаєш? — запитала вона, тримаючи блискуче каміння.
              — Так! Де ти їх знайшла? — запитав Рорі. — Вони лежали самі по
              собі. Я подумала, що хтось залишив їх. Рорі здивовано кліпнув, а
              потім м’яко засміявся. — Вони були частиною мого оформлення. Тома
              винувато опустила очі і простягнула їх назад. Рорі взяв камінці і
              тепло усміхнувся. — Дякую, мені це дуже приємно.
            </p>
          </div>

          <div>
            <img
              src="./images/image_4_3.png"
              className="image_fox image_fox_4_3"
            />
          </div>
        </div>
        <h2>
          Питання: Що відчував Рорі, коли Тома повернула загублені камінці?
        </h2>
