...
const Fourth_p_1 = () => {
  ...
  const handleEmotionClick = (emotion) => {
    if (emotion === "Смуток") {
      ...
      navigate("/fourth_p_2"); // Navigate to the next page when "Смуток" is clicked
    } else {
  ...
  const handleNextClick = () => {
    navigate("/fourth_p_2"); // Navigate to the next page when "Далі" is clicked
  };
      ...
      <main className="container">
        ...
        <div className="first_story">
          <div className="text_block">
            <p>{Pages[0].text}</p> {/* Displaying the first story's text */}
          </div>

          <div>
            <img
              src="./images/image_4_1.png"
              className="image_fox image_fox_4_1"
            />
          </div>
        </div>
        <h2>{Pages[0].questions}</h2>{" "}
        {/* Displaying the question for the first story */}
        <div className="variables">
          ...
          <div className="right_variant">
            <button
              className={`btn_variant wrong_btn ${
                selectedEmotion === "Розгубленість" ? "red" : ""
              }`}
                ...
                <div className="inmodal">
                  <div className="mb-3-3">
                    ...
                    <p>
                      ...
                      шапочку, а тепер не може її знайти...
                    </p>
                  </div>
                  <button
                    className="close_btn"
