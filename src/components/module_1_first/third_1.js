...
const Third1 = () => {
    ...
    const handleEmotionClick = (emotion) => {
        if (emotion === 'Смуток') {
            ...
            navigate('/fourth_1'); // Navigate to the next page when "Смуток" is clicked
        } else {
    ...
    const handleNextClick = () => {
        navigate('/fourth_1'); // Navigate to the next page when "Далі" is clicked
    };
    return (
        <div>
          ...
          ← 
                ...
                <div className="first_story">
                    <div className="text_block">
                        <p>Щоб подякувати, Міло запросив Беллу на пікнік. Він взяв солодкі ягоди та лісовий чай, а Белла принесла свої улюблені хрусткі морквини. Вони знайшли сонячне місце і розстелили ковдру. Але щойно сіли, як небо вкрили сірі хмари. Грім загримів, і дощ залив усе навколо. Їжа намокла, а ковдра промокла. Ніс Белли зморщився, вона затулила голову вухами й штовхнула шишку лапкою, нічого не кажучи.
                        </p>
                    </div>

                    <div>
                        <img src="./images/fox_3.png" className="image_fox image_fox3" />
                    </div>
                </div>
                <h2>Питання: Що відчувала Белла, коли дощ зіпсував пікнік?</h2>
