      ...
      <main className="container">
        ...
        <div className="first_story">
          <div className="text_block">
            <p>
              Коли дощ припинився, небо стало м’яким і золотавим. Сонячні
              промені пробилися крізь хмари, а крихітні краплі блищали на
              кожному листочку. Міло й Белла повільно йшли назад до нори,
              балакаючи й сміючись. Дорогою Белла побачила равлика, який застряг
              на мокрій стежці. Вона обережно підняла його й поставила на сухий
              камінець. — Ось і безпечно, — тихо сказала вона. Міло усміхнувся.
              — Ти завжди комусь допомагаєш. Це дуже добре з твого боку. Белла
              моргнула, а потім широко усміхнулась. — Дякую, Міло. Мені дуже
              приємно.
            </p>
          </div>

          <div>
            <img src="./images/fox_5.png" className="image_fox image_fox5" />
          </div>
        </div>
        <h2>Питання: Що відчувала Белла, коли Міло назвав її доброю?</h2>
