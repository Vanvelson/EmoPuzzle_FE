...
const Fourth = () => {
  ...
  const handleEmotionClick = (emotion) => {
    if (emotion === "Смуток") {
      ...
      navigate("/fifth_1"); // Navigate to the next page when "Смуток" is clicked
    } else {
  ...
  const handleNextClick = () => {
    navigate("/fifth_1"); // Navigate to the next page when "Далі" is clicked
  };
      ...
      <main className="container">
        ...
        <div className="first_story">
          <div className="text_block">
            <p>
              Вони хихотіли, сидячи під деревом, а краплі дощу м’яко стукали по
              листю над головами. Міло знову відкрив кошик і витяг дві солодкі
              ягоди, які не намокли. — Дивись, ягоди пережили бурю! — усміхнувся
              він. Белла взяла одну й радісно захрумтіла. — А з лісовим чаєм —
              ще смачніше! Вони підняли свої маленькі чашки й легенько цокнулись
              ними, ніби за тост. — За пікніки під дощем! — засміялася Белла.
              Хоча ковдра промокла, а їжа була зіпсована, їм було тепло й весело
              разом.
            </p>
          </div>

          <div>
            <img src="./images/fox_4.png" className="image_fox image_fox4" />
          </div>
        </div>
        <h2>
