...
const Bella = () => {
    ...
    const handleEmotionClick = (emotion) => {
        if (emotion === 'Смуток') {
            ...
            navigate('/third_1'); // Navigate to the next page when "Смуток" is clicked
        } else {
    ...
    const handleNextClick = () => {
        navigate('/third_1'); // Navigate to the next page when "Далі" is clicked
    };
          ...
          ← 
                ...
                <div className="first_story">
                    <div className="text_block">
                        <p>Раптом до нього підстрибала Белла, кролиця, з яскравою усмішкою.
                            — Доброго ранку, Міло! — весело мовила вона.
                            Міло не відповів, але Белла нахилила голову і запитала, що сталося. Почувши про зниклу шапочку, вона смикнула носиком.
                            — Ходімо пошукаємо її! — сказала вона. Разом вони обшукали весь ліс — за кущами, на пагорбах і під грибами. Через деякий час очі Белли заблищали.
                            — Подивись вгору! — вигукнула вона. На гілці дерева майоріло щось червоне й знайоме. Міло розплющив очі, радісно стрибнув і зірвав шапочку.
                            </p>
                    </div>

                    <div>
                        <img src="./images/fox_2.png" className="image_fox image_fox2" />
                    </div>
                </div>
                <h2>Питання: Що відчував Міло, коли Белла допомогла йому знайти шапоч</h2>
                ...
                <div className="variables">
                    ...
                    <button
                        ...
                        >
                            Радість
                            <img src="./images/gif/module_1/second_level/Joy2-unscreen.gif" className="image_gif" />
                        </button>
                        ...
                        >
                            Здивування
                            <img src="./images/gif/module_1/second_level/Amazement2-unscreen.gif" className="image_gif" />
                        </button>
                    </div>
                    ...
                    <button
                        ...
                        >
                            Вдячність
                            <img src="./images/gif/module_1/second_level/Gratitude2-unscreen.gif" className="image_gif" />
                        </button>
                        <button
                            className={`btn_variant wrong_btn ${selectedEmotion === 'Злість' ? 'red' : ''}`}
                            onClick={() => handleEmotionClick('Злість')}
                        >
                            Полегшення
                            <img src="./images/gif/module_1/second_level/Relief2-unscreen.gif" className="image_gif" />
                        </button>
                    </div>
