...
const FirstLevel = () => {
  ...
  const goToLostCap = () => {
    navigate("/lostcap"); // Навігація на сторінку LostCap
  };

  const goToSecond_1 = () => {
    navigate("/second_1"); // Навігація на сторінку LostCap
  };

  const goToThird_1 = () => {
    navigate("/third_p_1"); // Навігація на сторінку LostCap
  };
  const goToFourth_1 = () => {
    navigate("/fourth_p_1"); // Навігація на сторінку LostCap
  };
          ...
          <div className="left-side_block">
            <div className="module_block">
              <div className="first_block">
                ...
                <p onClick={goToLostCap}>Загублена шапочка</p>
              </div>
            </div>
            <div className="module_block">
              <div className="first_block">
                <div className="block_number">2</div>
                <p onClick={goToSecond_1}>Белла приходить на допомогу</p>
              </div>
            </div>
            <div className="module_block">
              <div className="first_block">
                <div className="block_number">3</div>
                <p onClick={goToThird_1}>Зіпсований пікнік</p>
              </div>
            </div>
            <div className="module_block">
              <div className="first_block">
                <div className="block_number">4</div>
                <p onClick={goToFourth_1}>Радість під дощем</p>
              </div>
            </div>
            <div className="module_block">
              <div className="first_block">
