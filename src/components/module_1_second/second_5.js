          ...
          ← 
                ...
                <div className="first_story">
                    <div className="text_block">
                        <p>Коли сонце почало сідати, золотисте світло заливало ліс. Ніко й Тора тихенько сиділи на колоді, спостерігаючи, як небо змінює кольори — рожевий, помаранчевий і ніжно-фіолетовий. Раптом над ними пролетіла сім’я птахів у формі літери V.
                            — Ого... — прошепотів Ніко.
                            Його очі засяяли, поки він проводжав їх поглядом.
                            — Вони ніби танцюють у небі!
                            Тора відкинулась назад і посміхнулася.
                            — Природа — справді дивовижна, правда?
                            Ніко повільно кивнув, відчуваючи себе маленьким, щасливим і зачарованим одночасно.
                        </p>
                    </div>

                    <div>
                        <img src="./images/fox_2_5.png" className="image_fox image_fox_2_5" />
                    </div>
                </div>
                <h2>Питання: Що відчував Ніко, коли дивився на птахів у небі?</h2>
                ...
                <div className="variables">
                    <div className="left_variant">
                        ...
                        >
                            Смуток
                            <img src="./images/gif/module_2/fifth2_level/Sadness5-unscreen.gif" className="image_gif" />
                        </button>
                        <button
                        ...
                        >
                            Захоплення
                            <img src="./images/gif/module_2/fifth2_level/Admiration5-unscreen.gif" className="image_gif" />
                        </button>
                    </div>
                    <div className="right_variant">
                        ...
                        >
                            Сонливість
                            <img src="./images/gif/module_2/fifth2_level/Drowsiness5-unscreen.gif" className="image_gif" />
                        </button>
                        <button
                            className={`btn_variant wrong_btn ${selectedEmotion === 'Злість' ? 'red' : ''}`}
                            onClick={() => handleEmotionClick('Злість')}
                        >
                            Злість
                            <img src="./images/gif/module_2/fifth2_level/Anger5-unscreen.gif" className="image_gif" />
                        </button>
                    </div>
