...
const Second_2 = () => {
  ...
  const handleEmotionClick = (emotion) => {
    if (emotion === "Смуток") {
      ...
      navigate("/second_3"); // Navigate to the next page when "Смуток" is clicked
    } else {
  ...
  const handleNextClick = () => {
    navigate("/second_3"); // Navigate to the next page when "Далі" is clicked
  };
  return (
      ...
      <main className="container">
        ...
        <div className="first_story">
          <div className="text_block">
            <p>
              У цей момент повз проходила Тора, черепаха. — Ти виглядаєш...
              розгублено, — сказала вона. Ніко показав на горіх. — Він не
              відкривається! Я вже все пробував. Тора глянула, покотила горіх
              під корінь дерева і натисла панциром. Трісь! Горіх розколовся
              навпіл. Очі Ніко стали круглі. — Ого... Це було круто! — сказав
              він і глибоко зітхнув. Нарешті можна поїсти.
            </p>
          </div>

          <div>
            <img
              src="./images/fox_2_2.png"
              className="image_fox image_fox_2_2"
            />
          </div>
        </div>
        <h2>
          Питання: Що відчував Ніко, коли Тора допомогла йому відкрити горіх?
        </h2>
