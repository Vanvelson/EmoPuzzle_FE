...
const Second_3 = () => {
    ...
    const handleEmotionClick = (emotion) => {
        if (emotion === 'Смуток') {
            ...
            navigate('/second_4'); // Navigate to the next page when "Смуток" is clicked
        } else {
    ...
    const handleNextClick = () => {
        navigate('/second_4'); // Navigate to the next page when "Далі" is clicked
    };
          ...
          ← 
                ...
                <div className="first_story">
                    <div className="text_block">
                        <p>Ніко простягнув другу половинку Торі.
                            — Хочеш трохи? Ти мене врятувала.
                            Тора усміхнулась і зробила маленький укус.
                            — Хрумке, — сказала вона.
                            Ніко засміявся.
                            — Добре, що ти була поруч. Дякую!
                        </p>
                    </div>

                    <div>
                    <img src="./images/fox_2_3.png" className="image_fox image_fox_2_3" />
                    </div>
                </div>
                <h2>Питання: Що відчував Ніко, коли поділився горіхом із Торою?</h2>
