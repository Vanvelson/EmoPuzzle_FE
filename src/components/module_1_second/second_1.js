...
const Second_1 = () => {
  ...
  const handleEmotionClick = (emotion) => {
    if (emotion === "Смуток") {
      ...
      navigate("/second_2"); // Navigate to the next page when "Смуток" is clicked
    } else {
  ...
  const handleNextClick = () => {
    navigate("/second_2"); // Navigate to the next page when "Далі" is clicked
  };
      ...
      <main className="container">
        ...
        <div className="first_story">
          <div className="text_block">
            <p>
              Ніко, маленький білченя, мчав лісом. Його лапки майже не торкались
              землі. Сьогодні він мав мету: знайти найбільший і найхрусткіший
              горіх у всьому лісі. Він перестрибнув коріння, обнюхав купи листя
              — і нарешті побачив його! Горіх лежав під кущем, ніби справжній
              скарб. — Є! — вигукнув Ніко. Він поклав горіх у сумку й побіг до
              свого улюбленого каменя. Ніко міцно тримав горіх і спробував його
              покрутити. Нічого. Він трохи надкусив — знову нічого. Він вдарив
              ним об камінь — один раз, другий, п’ятий — але шкаралупа не
              тріскалась. Його вушка опустилися. Він надув щоки, підкинув горіх
              угору, спіймав і знову спробував. — Уф! Ну чому ж? — роздратовано
              сказав він. Після ще кількох спроб Ніко сів на землю, склав лапки
              і нахмурився.
            </p>
          </div>
          ...
          <div>
            <img
              src="./images/fox_2_1.png"
              className="image_fox image_fox_2_1"
            />
          </div>
        </div>
        <h2>Питання: Що відчував Ніко, коли не міг розколоти горіх?</h2>
