...
const Third_p_2 = () => {
    ...
    const handleEmotionClick = (emotion) => {
        if (emotion === 'Смуток') {
            ...
            navigate('/third_p_3'); // Navigate to the next page when "Смуток" is clicked
        } else {
    ...
    const handleNextClick = () => {
        navigate('/third_p_3'); // Navigate to the next page when "Далі" is clicked
    };
          ...
          ← 
                ...
                <div className="first_story">
                    <div className="text_block">
                        <p>Вона знову глибоко вдихнула і спробувала ще раз. Цього разу вона заграла всю мелодію чудово. Звуки легко летіли між деревами. Коли вона закінчила, звірята захлопали в долоньки й копитця. Сови навіть загукали.
                            Серце Ліли калатало, але тепер було легке. Вона з усмішкою зістрибнула зі сцени.
                        </p>
                    </div>

                    <div>
                        <img src="./images/fox_3_2.png" className="image_fox3_2 image_fox" />
                    </div>
                </div>
                <h2>Питання: Що відчувала Ліла після того, як гарно зіграла свою мелодію?</h2>
