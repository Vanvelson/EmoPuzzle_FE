...
const Third_p_4 = () => {
    ...
    const handleEmotionClick = (emotion) => {
        if (emotion === 'Смуток') {
            ...
            navigate('/third_p_5'); // Navigate to the next page when "Смуток" is clicked
        } else {
    ...
    const handleNextClick = () => {
        navigate('/third_p_5'); // Navigate to the next page when "Далі" is clicked
    };
          ...
          ← 
                ...
                <div className="first_story">
                    <div className="text_block">
                        <p>Раптом з кущів вискочив білченя, тримаючи в лапках шишку.
                            — Вибач! Я не хотів нікого лякати! — засміявся він.
                            Ліла й Бенні переглянулися — а потім засміялися разом.
                            — Ніяких монстрів, — усміхнувся Бенні.
                            — Лише дуже галасливе білченя, — сказала Ліла.
                            Вона відчула, що стала сміливішою. Це був великий день — і вона пишалася собою.
                        </p>
                    </div>

                    <div>
                        <img src="./images/fox_3_4.png" className="image_fox image_fox3_4" />
                    </div>
                </div>
                <h2>Питання: Що відчувала Ліла, коли зрозуміла, що це не монстр?</h2>
