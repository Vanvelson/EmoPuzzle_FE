          ...
          ← 
                ...
                <div className="first_story">
                    <div className="text_block">
                        <p>Коли сонце сховалося за верхівки дерев, Ліла, Бенні та білченя сиділи разом на колоді, ласували хрусткими морквинками й тепло усміхалися. Концерт талантів завершився, а ліс знову став тихим. Ліла поглянула на зірки, що почали з’являтися в небі.
                            — Сьогодні було страшно… але водночас чудово, — прошепотіла вона.
                            Бенні кивнув.
                            — Ти була молодець.
                            У грудях Ліли розлилось спокійне, горде відчуття. Вона подолала страх, заграла свою мелодію і створила нові спогади. Вона знала — цей день запам’ятається надовго.
                        </p>
                    </div>

                    <div>
                        <img src="./images/fox_3_5.png" className="image_fox image_fox5" />
                    </div>
                </div>
                <h2>Питання: Що відчувала Ліла, згадуючи свій день?</h2>
