...
import "./third_p_all.css"; // Імпортуємо компонент
...
const App = () => {
    ...
    const handleEmotionClick = (emotion) => {
        if (emotion === 'Смуток') {
            ...
            navigate('/third_p_2'); // Navigate to the next page when "Смуток" is clicked
        } else {
    ...
    const handleNextClick = () => {
        navigate('/third_p_2'); // Navigate to the next page when "Далі" is clicked
    };
    return (
          ...
          ← 
                ...
                <div className="first_story">
                    <div className="text_block">
                        <p>Ліла, маленька кролиця, дуже хвилювалася. Сьогодні — лісовий концерт талантів, і вона мала грати на флейті перед усіма! Вона тижнями тренувалась і вже могла грати улюблену мелодію навіть із заплющеними очима.
                            Але коли нарешті настала її черга, лапки стали вологими. Вона вийшла на дерев’яну сцену. Усі звірі дивилися на неї. Ліла підняла флейту, вдихнула... і чхнула!
                            — АПЧХИ!
                            Звук луною прокотився через галявину. Кілька звірят захихотіли. Ліла почервоніла, її вушка опустились.
                            Вона глянула вниз і тихо сказала:
                            — Ой...
                    ...
                    <div>
                        <img src="./images/fox_3_1.png" className="image_fox image_fox_3_1" />
                    </div>
                </div>
                <h2>Питання: Що відчувала Ліла, коли чхнула на сцені?</h2>
